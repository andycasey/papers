...
% discuss the production of Oxygen
...
% Wylie de boer claim from their Na-O abundances that...
% Wylie de boer abundances themselves do not demonstrate the classical Na-O anti-correlation. In fact, they have a slight positive relationship. However, this trend is drawn from a sample of 5 stars -- the same as this study. If there is any evidence of a globular cluster from the [Na/Fe], [O/Fe] abundances in the Wylie de Boer study, it is the fact that two of their stars have slightly super-solar Na abundances; which is higher than expected for halo stars of this metallicity.

% How our measurements of Na, O compare to theirs
