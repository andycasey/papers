...
% [DONE] Mg/Al subplots
% - Ni/Na plane plot
% - Add standard stars to observations table
% - Add standard stars chemical abundances
...
% Casey, Keller, Alves-Brito, Frebel, Da Costa, Schlaufman, Karakas, Jacobson, Yu, Freeman
