...
accompaning_texts = [
        "C2225316-14437\t\t$T_{\\rm eff}$ = 4365 K, $\log{g}$ = 1.25, [Fe/H] = $-$1.22",
        "C2306265-085103\t\t$T_{\\rm eff}$ = 4225 K, $\log{g}$ = 0.85, [Fe/H] = $-$1.13",
        "J221821-183424\t\t$T_{\\rm eff}$ = 4630 K, $\log{g}$ = 0.88, [Fe/H] = $-$1.58",
        "J223504-152834\t\t$T_{\\rm eff}$ = 4650 K, $\log{g}$ = 2.16, [Fe/H] = $-$0.63",
        "J223811-104126\t\t$T_{\\rm eff}$ = 5190 K, $\log{g}$ = 2.93, [Fe/H] = $-$1.43"
        ]
