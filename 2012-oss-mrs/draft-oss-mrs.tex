...
We have presented a detailed analysis to isolate individual Orphan Stream K giants from low resolution spectroscopy using a combination of photometric, kinematic, gravity, and metallicity information. Although each individual criterion is likely to induce some level contamination, their intersection reveals highly probable, self-consistent, Orphan Stream K giants.  We deduce a median stream metallicity of $[\mbox{Fe/H}] = -1.71$ which is not biased by spectral type, and find an intrinsically wide metallicity spread of $\sigma = 0.56$\,dex, indicative of a dSph origin. Recall that the metallicity determination was performed after kinematic and gravity cuts, and our most probable members lay perfectly on a 10 Gyr isochrone of $[\mbox{Fe/H}] = -1.71$. Our stream members indicate a revised distance to the stream of $YY$\,kpc at $(l, b) = (250\,^\circ$, $50\,^\circ)$, Z\,kpc slightly farther than that deduced by \citet{Newberg;et-al_2010}.
